    ...
    <div className="min-h-screen relative overflow-hidden bg-black">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full px-4 pt-40 pb-24">
          <h1 className="text-8xl md:text-9xl font-extrabold text-purple-400 text-center mb-8 leading-tight drop-shadow-2xl">
            404
          </h1>
          <h2 className="text-4xl md:text-5xl font-bold text-white text-center mb-8 leading-tight drop-shadow-2xl">
            Page Not Found
          </h2>
          <p className="text-2xl md:text-2xl text-white/90 mb-10 max-w-2xl mx-auto text-center drop-shadow-lg leading-relaxed">
          ...
          <div className="w-full max-w-2xl mx-auto">
            <div className="space-y-6">
              <a 
                href="/" 
                className="block bg-white text-black font-bold px-8 py-4 rounded-xl hover:bg-gray-200 transition-all shadow-lg text-center text-lg"
              >
                Go to Homepage
              </a>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a 
                  href="/discover" 
                  className="bg-black/40 backdrop-blur-sm text-white font-semibold px-6 py-3 rounded-xl hover:bg-black/60 transition-all border border-white/20 text-center"
                >
                  Discover Events
                </a>
                <a 
