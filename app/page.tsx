      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full px-4 pt-40 pb-24">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <a href="/discover" className="bg-white text-gray-900 font-bold text-lg px-8 py-4 rounded-xl shadow hover:bg-gray-100 transition-all text-center">
              Discover Events
            </a>
            <a href="/create-event" className="bg-white text-gray-900 font-bold text-lg px-8 py-4 rounded-xl shadow hover:bg-gray-100 transition-all text-center">
              Create Event
            </a>
          </div>
        </div>
        ...
        <section className="relative py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-8 group hover:scale-105 transition-all duration-500 bg-black/40 backdrop-blur-sm rounded-xl border border-white/10">
